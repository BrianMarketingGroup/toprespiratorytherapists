...
export default function ContactForm() {
  ...
  const {
    ...
    defaultValues: { type: "contact", consentToContact: true },
  });
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center gap-4 py-10 text-center">
        ...
        <h3 className="race-head text-2xl text-pearl">Message Received</h3>
        <p className="text-muted">
          Thank you for reaching out to the TopRespiratoryTherapists.com team. A member of our team will be in touch shortly.
        </p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
      ...
      <FormField label="Message" required error={errors.message?.message}>
        <Textarea {...register("message")} error={errors.message?.message} placeholder="Tell us about your respiratory practice, your specialties, and the cities you&apos;d like to be listed in…" />
      </FormField>
      ...
      <div className="space-y-1">
        <label className="flex items-start gap-3 cursor-pointer">
          ...
          <span className="text-sm text-muted leading-snug">
            I consent to being contacted by the TopRespiratoryTherapists.com team regarding my inquiry, and agree to receive marketing communications via email or SMS. Reply STOP to opt out at any time.
          </span>
        </label>
